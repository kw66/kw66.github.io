    ...
    <div class='featured-track' id='featured-track'>
      <article class='featured-item' data-featured-item>
        ...
        <div class='featured-item-body'>
          ...
          <div class='featured-actions'>
            <a class='featured-button' href='https://arxiv.org/abs/2509.16635' target='_blank' rel='noopener noreferrer'>&#128196; 论文</a>
            <a class='featured-button' href='https://github.com/kw66/AT-ReID' target='_blank' rel='noopener noreferrer'>&#128451;&#65039; 数据集</a>
            <a class='featured-button' href='https://github.com/kw66/AT-ReID/tree/main/AT-ReID' target='_blank' rel='noopener noreferrer'>&#128187; 代码</a>
          </div>
        </div>
      </article>
      ...
      <article class='featured-item' data-featured-item>
        ...
        <div class='featured-item-body'>
          ...
          <div class='featured-actions'>
            ...
            <a class='featured-button' href='https://github.com/kw66/PhD_Simulator' target='_blank' rel='noopener noreferrer'>&#128736;&#65039; 项目</a>
          </div>
        </div>
      </article>
      ...
      <article class='featured-item' data-featured-item>
        ...
        <div class='featured-item-body'>
          ...
          <div class='featured-actions'>
            ...
            <a class='featured-button' href='https://github.com/kw66/PhD_Simulator_V2' target='_blank' rel='noopener noreferrer'>&#128736;&#65039; 项目</a>
          </div>
        </div>
      </article>
      ...
      <article class='featured-item' data-featured-item>
        ...
        <div class='featured-item-body'>
          ...
          <div class='featured-actions'>
            ...
            <a class='featured-button' href='https://github.com/kw66/study-ascension' target='_blank' rel='noopener noreferrer'>&#128736;&#65039; 项目</a>
          </div>
        </div>
      </article>
      ...
      <article class='featured-item' data-featured-item>
        ...
        <div class='featured-item-body'>
          ...
          <div class='featured-actions'>
            ...
            <a class='featured-button' href='https://github.com/kw66/photo-hero' target='_blank' rel='noopener noreferrer'>&#128736;&#65039; 项目</a>
          </div>
        </div>
      </article>
      ...
      <article class='featured-item' data-featured-item>
        ...
        <div class='featured-item-body'>
          ...
          <div class='featured-actions'>
            ...
            <a class='featured-button' href='https://github.com/kw66/campus-memoir' target='_blank' rel='noopener noreferrer'>&#128736;&#65039; 项目</a>
          </div>
        </div>
      </article>
      ...
      <article class='featured-item' data-featured-item>
        ...
        <div class='featured-item-body'>
          ...
          <div class='featured-actions'>
            ...
            <a class='featured-button' href='https://github.com/kw66/kw-chess' target='_blank' rel='noopener noreferrer'>&#128736;&#65039; 项目</a>
          </div>
        </div>
      </article>
      ...
      <article class='featured-item' data-featured-item>
        ...
        <div class='featured-item-body'>
          ...
          <div class='featured-actions'>
            <a class='featured-button' href='https://github.com/kw66/research-figures' target='_blank' rel='noopener noreferrer'>&#128736;&#65039; 项目</a>
          </div>
        </div>
      </article>
    </div>
...
<div class='paper-filter-toolbar'>
  <div class='paper-filter-row' id='paper-filter-row' role='group' aria-label='按标签筛选论文'>
    <button class='paper-filter-chip' type='button' data-filter-tag='selected' aria-pressed='true'>Selected</button>
...
<section class='paper-list' id='paper-list' aria-labelledby='publications-heading'>
  <article class='paper-list-item' data-paper-tags='selected,reid,moe,frequency'>
    <p class='paper-entry'>
      ...
      <span class='paper-actions'><a class='paper-link-button' href='https://arxiv.org/abs/2606.12051' target='_blank' rel='noopener noreferrer'>&#128196; 论文</a> <a class='paper-link-button' href='https://github.com/kw66/research-figures/tree/main/MFEN' target='_blank' rel='noopener noreferrer'>&#127912; 画图PPT</a></span>
    </p>
  </article>
  ...
  <article class='paper-list-item' data-paper-tags='selected,reid,moe,multi-task-learning'>
    <p class='paper-entry'>
      ...
      <span class='paper-actions'><a class='paper-link-button' href='https://arxiv.org/abs/2509.16635' target='_blank' rel='noopener noreferrer'>&#128196; 论文</a> <a class='paper-link-button' href='https://github.com/kw66/AT-ReID' target='_blank' rel='noopener noreferrer'>&#128736;&#65039; 项目</a> <a class='paper-link-button' href='https://github.com/kw66/research-figures/tree/main/AT-ReID' target='_blank' rel='noopener noreferrer'>&#127912; 画图PPT</a></span>
    </p>
  </article>
  ...
  <article class='paper-list-item' data-paper-tags='selected,reid,causal-inference,graph'>
    <p class='paper-entry'>
      ...
      <span class='paper-actions'><a class='paper-link-button' href='https://arxiv.org/abs/2208.00967' target='_blank' rel='noopener noreferrer'>&#128196; 论文</a> <a class='paper-link-button' href='https://github.com/kw66/research-figures/tree/main/CIFT' target='_blank' rel='noopener noreferrer'>&#127912; 画图PPT</a></span>
    </p>
  </article>
  ...
  <article class='paper-list-item' data-paper-tags='selected,reid,metric-learning'>
    <p class='paper-entry'>
      ...
      <span class='paper-actions'><a class='paper-link-button' href='https://link.springer.com/chapter/10.1007/978-3-031-18907-4_41' target='_blank' rel='noopener noreferrer'>&#128196; 论文</a> <a class='paper-link-button' href='https://github.com/kw66/research-figures/tree/main/CACC' target='_blank' rel='noopener noreferrer'>&#127912; 画图PPT</a></span>
    </p>
  </article>
</section>
...
<script>
  (function () {
    ...
    const activePaperFilters = new Set(['selected']);
    const featuredState = {
      index: 0,
      visibleCount: 1,
      autoScrollTimerId: 0,
    ...
    function buildLane(side, height, layer) {
      const baseSpacing = mascotConfig.size + mascotConfig.gap;
      const itemCount = Math.ceil(height / baseSpacing) + mascotConfig.preloadCount;
      const items = [];
    ...
    function recycleLaneForward(lane) {
    ...
    function recycleLaneBackward(lane) {
    ...
    function advanceLane(lane, distance) {
      ...
      if (lane.direction === 1) {
        while (lane.headY >= 0) {
          recycleLaneForward(lane);
        }
        return;
      }

      while (lane.headY <= -lane.baseSpacing) {
        recycleLaneBackward(lane);
      }
    }
    ...
    function mascotStep(now) {
      ...
      const distance = mascotConfig.speed * dt;
    ...
    function spinAuthorAvatar() {
      ...
      const positions = Array.from({ length: frameCount }, (_, index) => -((index / frameCount) * 100));
      const keyframes = positions.map((translate, index) => {
        const offsets = [0, 0.17, 0.34, 0.51, 0.68, 0.84, 1];
        const frame = {
          transform: `translateX(${translate.toFixed(4)}%)`,
          offset: offsets[Math.min(index, offsets.length - 1)]
        };
        if (index === 0) {
    ...
    function updatePaperFilterButtons() {
      ...
      document.querySelectorAll('[data-filter-tag]').forEach((button) => {
        ...
        const isActive = tag === 'all' ? allActive : activePaperFilters.has(tag);
        button.classList.toggle('is-active', isActive);
    ...
    function applyPaperFilters() {
      const items = Array.from(document.querySelectorAll('.paper-list-item[data-paper-tags]'));
      const emptyState = document.getElementById('paper-filter-empty');
      const activeTags = Array.from(activePaperFilters);
      let visibleCount = 0;

      items.forEach((item) => {
        const tags = item.dataset.paperTags.split(',').map((tag) => tag.trim()).filter(Boolean);
        const matched = activeTags.length === 0 || activeTags.every((tag) => tags.includes(tag));
        item.hidden = !matched;
        if (matched) {
          visibleCount += 1;
        }
    ...
    function getFeaturedItems(options = {}) {
      const originalsOnly = !!options.originalsOnly;
      return Array.from(document.querySelectorAll('[data-featured-item]')).filter((item) => {
        if (!originalsOnly) return true;
        return item.dataset.featuredClone !== 'true';
      });
    }
    ...
    function pauseFeaturedAutoScroll(duration = 2400) {
      featuredState.autoScrollPauseUntil = (window.performance?.now?.() || 0) + duration;
    }

    function getFeaturedMobileImageHeight() {
      return clamp(getViewportWidth() * 0.28, 96, 126);
    }

    function getFeaturedMobileItemWidth(item) {
      ...
      const targetWidth = getFeaturedMobileImageHeight() * aspectRatio;
    ...
    function updateFeaturedButtons() {
      const maxIndex = Math.max(0, getFeaturedItems({ originalsOnly: true }).length - featuredState.visibleCount);
      document.querySelectorAll('[data-featured-nav]').forEach((button) => {
        const action = button.dataset.featuredNav;
        const disabled = action === 'prev' ? featuredState.index <= 0 : featuredState.index >= maxIndex;
        button.disabled = disabled;
        button.classList.toggle('is-disabled', disabled);
      });
    }

    function scrollFeatured(behavior) {
      ...
      const target = items[featuredState.index];
      if (!target) return;
      viewport.scrollTo({
    ...
    function syncFeaturedCarousel(behavior) {
      const track = document.getElementById('featured-track');
      const viewport = document.getElementById('featured-viewport');
      if (!track || !viewport) return;

      ensureFeaturedLoopStructure(track);
      syncFeaturedItemWidths();

      const items = getFeaturedItems({ originalsOnly: true });
      if (!track || !items.length) return;
      featuredState.visibleCount = Math.min(getFeaturedVisibleCount(), items.length);
      featuredState.index = clamp(
        featuredState.index,
        0,
        Math.max(0, items.length - featuredState.visibleCount)
      );
    ...
    function initFeaturedCarousel() {
      ...
      document.querySelectorAll('[data-featured-nav]').forEach((button) => {
        button.addEventListener('click', () => {
          const maxIndex = Math.max(0, getFeaturedItems({ originalsOnly: true }).length - featuredState.visibleCount);
          if (button.dataset.featuredNav === 'prev') {
            featuredState.index = clamp(featuredState.index - 1, 0, maxIndex);
          } else {
            featuredState.index = clamp(featuredState.index + 1, 0, maxIndex);
          }
          scrollFeatured(prefersReducedMotion ? 'auto' : 'smooth');
        });
      });
    }
    ...
    function spinSlotMachine() {
      ...
      tracks.forEach((track, index) => {
        ...
        const fallbackTimer = window.setTimeout(handleSettle, duration + 160);
        slotState.timers.push(fallbackTimer);
      });
    }
